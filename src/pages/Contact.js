  ...
  return (
    ...
    <section className="text-gray-600 body-font relative bg-[#f2f2f2] pt-5">
      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 p-10 rounded-xl">
          ...
          <button className="text-white bg-[#ff5757] border-0 py-2 px-6 focus:outline-none hover:bg-[#f72c2c] rounded text-lg">
            Submit
          </button>
